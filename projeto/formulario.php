<?php
  ...
  if(isset($_POST['submit']))
  {
    ...
    $result = mysqli_query($conexao, "INSERT INTO usuarios(nome,senha,confirmarsenha,usuario,email,data_nascimento,nomematerno,cpf,sexo,endereco,telefone,telefonefixo,doisfa) 
    VALUES ('$nome','$senha','$confirmarsenha','$usuario','$email','$data_nasc','$nomematerno','$cpf','$sexo','$endereco','$telefone','$telefonefixo','$doisfa')");
